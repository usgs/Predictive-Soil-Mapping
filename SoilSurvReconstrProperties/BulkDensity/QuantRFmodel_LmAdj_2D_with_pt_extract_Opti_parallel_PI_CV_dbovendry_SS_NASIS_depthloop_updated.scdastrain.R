...
predfolder <- "/home/tnaum/data/BLMsoils/BD_od_SSURGO_NASIS_SCD"
...
pts.ext$prop <- pts.ext$dbovendry_r ## UPDATE EVERY TIME
...
## SCD prep for RF
scd.pts.ext$prop <- scd.pts.ext$db_od ## UPDATE everytime!
scd.pts.ext$tid <- "scd"
...
rasterOptions(maxmemory = 1e+09,chunksize = 1e+08)
setwd("/home/tnaum/data/BLMsoils/BD_od_SSURGO_NASIS_SCD")
...
watermask_fn <- function(g){
  ...
  setwd("/home/tnaum/data/BLMsoils/BD_od_SSURGO_NASIS_SCD/masked")
