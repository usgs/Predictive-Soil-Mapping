...
predfolder <- "/home/tnaum/data/BLMsoils/Restrict_layer_SSURGO_NASIS"
...
## Save points
setwd(predfolder)
saveRDS(pts.ext, "UCRB_restrictdepth_NASIS_SSURGO18_ART_SG100_covs.rds")
## OR load Pre-prepared extract for UCRB
# pts.ext <- readRDS("/home/tnaum/data/gSSURGO18/ESGs_Restr_SurfFrags_gSSURGO18_NASIS/RestrLayer_NASIS_SSURGO/UCRB_restrictdepth_NASIS_SSURGO18_ART_SG100_covs.rds")

## Prep nasis training data for Random Forest
pts.ext$prop <- pts.ext$resdept_r ## UPDATE EVERY TIME
...
pts.extc$prop_t <- pts.extc$prop ## TRANSFORM IF NEEDED
attach(pts.extc)
...
rasterOptions(maxmemory = 1e+09,chunksize = 1e+08)
setwd("/home/tnaum/data/BLMsoils/Restrict_layer_SSURGO_NASIS")
...
watermask_fn <- function(g){
  ...
  setwd("/home/tnaum/data/BLMsoils/Restrict_layer_SSURGO_NASIS/masked")
