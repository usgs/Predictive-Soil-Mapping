...
predfolder <- "/home/tnaum/data/BLMsoils/FS_2D_NASIS_SSURGO_SCD"
...
pts.ext$prop <- pts.ext$sandfine_r ## UPDATE EVERY TIME
...
rasterOptions(maxmemory = 1e+09,chunksize = 1e+08)
setwd("/home/tnaum/data/BLMsoils/FS_2D_NASIS_SSURGO_SCD")
...
watermask_fn <- function(g){
  ...
  setwd("/home/tnaum/data/BLMsoils/FS_2D_NASIS_SSURGO_SCD/masked")
