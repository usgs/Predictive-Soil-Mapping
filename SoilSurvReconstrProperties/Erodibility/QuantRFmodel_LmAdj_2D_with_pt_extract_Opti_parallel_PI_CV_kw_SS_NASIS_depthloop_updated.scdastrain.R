...
## Save points
setwd(predfolder)
saveRDS(pts.ext, "UCRB_nasis_SSURGO_kw_r_ART_SG100_covarsc.rds")
...
## Load lab pedons and remove lab pedons from nasis data to allow for evaluation at end
...
## Random Raster Sample locations for RelPI stats
...
## Plotting options for examining cross validation
