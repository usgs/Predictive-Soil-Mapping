...
predfolder <- "/home/tnaum/data/BLMsoils/Avail_H2O_SSURGO_NASIS_SCD"
...
pts.ext$prop <- pts.ext$awc_r ## UPDATE EVERY TIME
...
## SCD prep for RF
scd.pts.ext$prop <- scd.pts.ext$wrd_ws13 ## UPDATE everytime!
scd.pts.ext$tid <- "scd"
...
rasterOptions(maxmemory = 1e+09,chunksize = 1e+08)
setwd("/home/tnaum/data/BLMsoils/Avail_H2O_SSURGO_NASIS_SCD")
...
watermask_fn <- function(g){
  ...
  setwd("/home/tnaum/data/BLMsoils/Avail_H2O_SSURGO_NASIS_SCD/masked")
