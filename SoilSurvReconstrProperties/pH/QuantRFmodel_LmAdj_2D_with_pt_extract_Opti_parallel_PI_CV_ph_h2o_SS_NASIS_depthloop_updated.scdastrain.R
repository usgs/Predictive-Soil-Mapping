...
predfolder <- "/home/tnaum/data/BLMsoils/pH_h2o_2D_SSURGO_NASIS_SCD"
...
pts.ext$prop <- pts.ext$ph1to1h2o_r ## UPDATE EVERY TIME
...
## SCD prep for RF
scd.pts.ext$prop <- scd.pts.ext$ph_h2o ## UPDATE everytime!
scd.pts.ext$tid <- "scd"
...
rasterOptions(maxmemory = 1e+09,chunksize = 1e+08)
setwd("/home/tnaum/data/BLMsoils/pH_h2o_2D_SSURGO_NASIS_SCD")
...
watermask_fn <- function(g){
  ...
  setwd("/home/tnaum/data/BLMsoils/pH_h2o_2D_SSURGO_NASIS_SCD/masked")
